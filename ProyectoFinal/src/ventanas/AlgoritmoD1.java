...
public class AlgoritmoD1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tittle.setText("Quick Sort");
        getContentPane().add(tittle, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, -1, -1));

        tittle1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        tittle1.setForeground(new java.awt.Color(255, 255, 255));
        tittle1.setText("Algoritmo Divide y Venceras 1");
    ...
    private void ingresarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarButtonActionPerformed
        ...
        AlgoritmoD1A algoritmo = new AlgoritmoD1A(texto.getArray());
