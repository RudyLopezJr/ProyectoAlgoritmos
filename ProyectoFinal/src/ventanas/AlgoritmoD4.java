...
import metodos.AlgoritmoD4A;

public class AlgoritmoD4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tittle1.setText("Algoritmo Divide y Venceras 4");
    ...
    private void ingresarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarButtonActionPerformed
        ...
        AlgoritmoD4A algoritmo = new AlgoritmoD4A(texto.getArray());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlgoritmoD4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlgoritmoD4().setVisible(true);
            }
        });
    }
